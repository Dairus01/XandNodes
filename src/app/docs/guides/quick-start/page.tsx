...
export const metadata = {
  title: "Quick Start - XandNodes Documentation",
  description: "Get up and running with XandNodes in minutes",
};
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-xl text-muted-foreground">
          Get XandNodes up and running in under 5 minutes
        </p>
      </div>
      ...
      <div>
        ...
        <CodeBlock
          code={`git clone https://github.com/Dairus01/XandNodes.git\ncd xandnodes`}
          language="bash"
          title="Terminal"
        />
        ...
        <h3 className="text-lg font-semibold mb-3">Step 3: Run Development Server</h3>
        <CodeBlock
          code={`npm run dev\n# or\nyarn dev`}
          language="bash"
          title="Dev Server"
        />
        <p className="mb-6">
          Open <a href="http://localhost:3000" className="text-primary hover:underline">http://localhost:3000</a> in your browser to see XandNodes running!
        </p>
      </div>
