  ...
  return (
    <Card className="border-2 bg-gradient-to-br from-card to-card/50">
      ...
      <CardContent>
        ...
        <div className="text-center py-2 px-4 rounded-lg bg-muted/50 border border-border/50 text-foreground mb-4">
        ...
        <div className="mt-4 space-y-3">
          ...
          <div className="flex justify-between text-xs">
            ...
            <span className="font-medium">{stats.activeCountries}</span>
          </div>
        </div>
      </CardContent>
    </Card>
